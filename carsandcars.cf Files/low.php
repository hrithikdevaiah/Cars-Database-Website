...
$sql = "SELECT * FROM cars , engine, gears_and_handling, look, performance, price WHERE cars.id=engine.id AND cars.id=gears_and_handling.id AND cars.id=look.id AND cars.id=performance.id AND cars.id=price.id ORDER BY price.new ASC";
